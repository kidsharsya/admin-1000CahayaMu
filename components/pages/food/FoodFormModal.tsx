        ...
        {showSuccess ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input type="text" name="name" value={form.name} onChange={handleChange} required className="w-full border rounded-md px-3 py-2 text-sm focus:ring-emerald-500 focus:border-emerald-500" placeholder="Contoh: Telur" />
            </div>
