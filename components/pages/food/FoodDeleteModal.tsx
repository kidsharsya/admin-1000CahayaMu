...
import { deleteFood } from '@/lib/api/food';
...
export function FoodDeleteModal({ isOpen, onClose, onSuccess, id, name }: FoodDeleteModalProps) {
      ...
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6 relative">
        ...
        {!showSuccess && (
          <>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-semibold text-gray-800">Hapus Jenis Makanan</h2>
            </div>
        ...
        {showSuccess && (
          <div className="text-center">
            ...
            <p className="text-gray-700 mb-4">Data jenis makanan berhasil dihapus.</p>
            <button
              onClick={() => {
