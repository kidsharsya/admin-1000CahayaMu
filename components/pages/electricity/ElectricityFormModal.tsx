        ...
        {showSuccess ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select name="category_id" value={form.category_id} onChange={handleChange} required disabled={loadingCategories} className="w-full border rounded-md px-3 py-2 text-sm focus:ring-emerald-500 focus:border-emerald-500 bg-white">
            ...
            <div>
              ...
              <input type="number" name="min_power_va" value={form.min_power_va} onChange={handleChange} required min={0} step={1} className="w-full border rounded-md px-3 py-2 text-sm focus:ring-emerald-500 focus:border-emerald-500" />
            </div>

            {/* Maksimal VA */}
            <div>
              <label className="block text-sm text-gray-600 mb-1">Daya Maksimal (VA)</label>
              <input type="number" name="max_power_va" value={form.max_power_va} onChange={handleChange} required min={0} step={1} className="w-full border rounded-md px-3 py-2 text-sm focus:ring-emerald-500 focus:border-emerald-500" />
            </div>

            {/* Tarif per kWh */}
            <div>
              <label className="block text-sm text-gray-600 mb-1">Tarif per kWh (Rp)</label>
              <input type="number" name="rate_per_kwh" value={form.rate_per_kwh} onChange={handleChange} required min={0} step={0.01} className="w-full border rounded-md px-3 py-2 text-sm focus:ring-emerald-500 focus:border-emerald-500" />
            </div>
