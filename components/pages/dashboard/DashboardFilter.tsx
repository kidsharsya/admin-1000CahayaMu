...
export function DashboardFilter() {
  ...
  const [regency, setRegency] = useState('semua');
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 w-full">
      ...
      {/* Province */}
      <select value={province} onChange={(e) => setProvince(e.target.value)} className="w-[300px] border border-gray-300 rounded-md py-2 px-3 text-sm focus:ring-2 focus:ring-emerald-500 focus:outline-none bg-white">
      ...
      {/* Regency */}
      <select value={regency} onChange={(e) => setRegency(e.target.value)} className="w-[300px] border border-gray-300 rounded-md py-2 px-3 text-sm focus:ring-2 focus:ring-emerald-500 focus:outline-none bg-white">
