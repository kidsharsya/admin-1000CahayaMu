    ...
    <tr className="border-b border-gray-200 last:border-none hover:bg-gray-50">
      ...
      <td>
        <div className="flex gap-2">
          <button type="button" onClick={() => onView?.(user_id)} className="bg-white hover:bg-blue-600 text-blue-600 hover:text-white rounded-md p-2 transition" title="Lihat Detail">
            <Eye className="w-4 h-4" />
          </button>

          <button type="button" onClick={() => onEdit?.(user_id)} className="bg-white hover:bg-emerald-600 text-emerald-600 hover:text-white rounded-md p-2 transition" title="Edit">
            <Pen className="w-4 h-4" />
          </button>

          <button type="button" onClick={() => onDelete?.(user_id, name)} className="bg-white hover:bg-red-600 text-red-600 hover:text-white rounded-md p-2 transition" title="Hapus">
