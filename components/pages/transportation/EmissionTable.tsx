...
import { TransportationRow } from './EmissionRow';
            ...
            <div key={vehicleType} className="border border-gray-200 rounded-xl shadow-sm bg-white overflow-hidden">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="text-gray-600 text-xs font-semibold border-b">
                    <tr>
                  ...
                  <tbody>
                    {items.map((item) => (
                      <TransportationRow key={item.id} {...item} onRequestEdit={handleEdit} onRequestDelete={(id) => handleDelete(id, item.vehicle_type)} />
                    ))}
                  </tbody>
                </table>
              </div>
