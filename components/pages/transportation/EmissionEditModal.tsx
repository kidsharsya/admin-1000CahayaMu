        ...
        {showSuccess ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input type="text" name="vehicle_type" value={form.vehicle_type} onChange={handleChange} required className="w-full border rounded-md px-3 py-2 text-sm focus:ring-emerald-500 focus:border-emerald-500" />
            </div>

            {/* Fuel Type */}
            <div>
              <label className="block text-sm text-gray-600 mb-1">Jenis Bahan Bakar</label>
              <select name="fuel_type" value={form.fuel_type} onChange={handleChange} required className="w-full border rounded-md px-3 py-2 text-sm focus:ring-emerald-500 focus:border-emerald-500">
            ...
            <div>
              ...
              <input type="text" name="capacity_range_label" value={form.capacity_range_label} onChange={handleChange} required className="w-full border rounded-md px-3 py-2 text-sm focus:ring-emerald-500 focus:border-emerald-500" />
            </div>
            ...
            <div>
              ...
              <input type="number" name="g_co2e_per_km" value={form.g_co2e_per_km} onChange={handleChange} required min={0} step={0.1} className="w-full border rounded-md px-3 py-2 text-sm focus:ring-emerald-500 focus:border-emerald-500" />
            </div>
