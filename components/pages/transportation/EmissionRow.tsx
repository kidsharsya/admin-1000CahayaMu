...
export function TransportationRow({ id, fuel_type, capacity_range_label, default_km_per_liter, g_co2e_per_km, active, onRequestEdit, onRequestDelete }: TransportationEmissionRowProps) {
  return (
    <tr className="border-b border-gray-100 last:border-none hover:bg-gray-50 transition">
